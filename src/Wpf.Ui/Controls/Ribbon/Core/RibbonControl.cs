...
public abstract class RibbonControl : System.Windows.Controls.Control, ICommandSource, IRibbonControl
{
    ...
    public static readonly DependencyProperty SimplifiedSizeDefinitionProperty = RibbonProperties.SimplifiedSizeDefinitionProperty.AddOwner(typeof(RibbonControl));

    /// <inheritdoc />
    public bool ShowInSimplified
    {
        get => (bool)this.GetValue(ShowInSimplifiedProperty);
        set => this.SetValue(ShowInSimplifiedProperty, Internal.KnowBoxes.BooleanBoxes.Box(value));
    }
    ...
    public static readonly DependencyProperty ShowInSimplifiedProperty =
        DependencyProperty.Register(nameof(ShowInSimplified), typeof(bool), typeof(RibbonControl), new PropertyMetadata(Internal.KnowBoxes.BooleanBoxes.TrueBox));

    /// <inheritdoc />
    public bool IsSimplified => false; // Base class always returns false, derived classes can override
    ...
    /// <inheritdoc />
    protected override AutomationPeer OnCreateAutomationPeer() => new RibbonControlAutomationPeer(this);
