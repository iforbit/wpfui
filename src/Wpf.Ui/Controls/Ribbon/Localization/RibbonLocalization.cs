...
using Wpf.Ui.Controls.Localization;
...
public class RibbonLocalization : INotifyPropertyChanged
{
    ...
    /// <summary>
    /// Gets static instance of <see cref="RibbonLocalization"/> to ease it's usage in XAML.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RibbonLocalization"/> class.
    /// Default constructor
    /// </summary>
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    {
        IList<Type> localizationClasses = GetTypesInNamespace(Assembly.GetExecutingAssembly(), "Wpf.Ui.Controls.Localization.Languages");
    ...
    {
        if (this.LocalizationMap.TryGetValue(requestedCulture.Name, out Type? localizationClass))
        {
