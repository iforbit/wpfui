...
namespace Wpf.Ui.Controls.Localization.Languages
{
    ...
    public class Russian : RibbonLocalizationBase
    {
        ...
        public override string DisplayOptionsButtonScreenTipText { get; } = "Настройка параметров отображения ленты.";
        public override string DisplayOptionsButtonScreenTipTitle { get; } = "Настройка отображения ленты";
        public override string ExpandRibbon { get; } = "Развернуть ленту";
        public override string MinimizeRibbon { get; } = "Свернуть ленту";
        ...
        public override string RibbonLayout { get; } = "Макет вида ленты";
        ...
        public override string ShowRibbon { get; } = "Разместить ленту";
