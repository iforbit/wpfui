...
namespace Wpf.Ui.Controls.Localization.Languages
{
    ...
    public class German : RibbonLocalizationBase
    {
        ...
        public override string DisplayOptionsButtonScreenTipText { get; } = "Anzeigeoptionen für das Menüband konfigurieren.";
        public override string DisplayOptionsButtonScreenTipTitle { get; } = "Anzeigeoptionen für das Menüband";
        public override string ExpandRibbon { get; } = "Menüband erweitern";
        public override string MinimizeRibbon { get; } = "Menüband minimieren";
        ...
        public override string RibbonLayout { get; } = "Menüband Layout";
        ...
        public override string ShowRibbon { get; } = "Menüband anzeigen";
