...
namespace Wpf.Ui.Controls.Localization.Languages
{
    ...
    public class Greek : RibbonLocalizationBase
    {
        ...
        public override string QuickAccessToolBarMenuHeader { get; } = "Προσαρμογή γραμμής εργαλείων γρήγορης πρόσβασης";
        public override string QuickAccessToolBarMenuShowAbove { get; } = "Εμφάνιση επάνω από την κορδέλα";
        public override string QuickAccessToolBarMenuShowBelow { get; } = "Εμφάνιση κάτω από την κορδέλα";
        public override string QuickAccessToolBarMoreControlsButtonTooltip { get; } = "Περισσότερα στοιχεία ελέγχου";
        public override string RibbonContextMenuAddGallery { get; } = "Προσθήκη Γκαλερί στη Γραμμή εργαλείων γρήγορης πρόσβασης";
        public override string RibbonContextMenuAddGroup { get; } = "Προσθήκη Ομάδας στη Γραμμή εργαλείων γρήγορης πρόσβασης";
        public override string RibbonContextMenuAddItem { get; } = "Προσθήκη στη Γραμμή εργαλείων γρήγορης πρόσβασης";
        public override string RibbonContextMenuAddMenu { get; } = "Προσθήκη Μενού στη Γραμμή εργαλείων γρήγορης πρόσβασης";
        public override string RibbonContextMenuCustomizeQuickAccessToolBar { get; } = "Προσαρμογή Γραμμής εργαλείων γρήγορης πρόσβασης...";
        public override string RibbonContextMenuCustomizeRibbon { get; } = "Προσαρμογή Κορδέλας...";
        public override string RibbonContextMenuMinimizeRibbon { get; } = "Ελαχιστοποίηση της Κορδέλας";
