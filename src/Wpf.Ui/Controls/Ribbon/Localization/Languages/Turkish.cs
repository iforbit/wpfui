...
namespace Wpf.Ui.Controls.Localization.Languages
{
    ...
    public class Turkish : RibbonLocalizationBase
    {
        ...
        public override string QuickAccessToolBarMenuShowAbove { get; } = "Şeridin Üstünde Göster";
        public override string QuickAccessToolBarMenuShowBelow { get; } = "Şeridin Altında Göster";
        public override string QuickAccessToolBarMoreControlsButtonTooltip { get; } = "Diğer denetimler";
        public override string RibbonContextMenuAddGallery { get; } = "Galeriyi Hızlı Erişim Araç Çubuğu'na Ekle";
        public override string RibbonContextMenuAddGroup { get; } = "Grubu Hızlı Erişim Araç Çubuğu'na Ekle";
        public override string RibbonContextMenuAddItem { get; } = "Hızlı Erişim Araç Çubuğu'na Ekle";
        public override string RibbonContextMenuAddMenu { get; } = "Menüyü Hızlı Erişim Araç Çubuğu'na Ekle";
        public override string RibbonContextMenuCustomizeQuickAccessToolBar { get; } = "Hızlı Erişim Araç Çubuğu'nu Özelleştir";
        public override string RibbonContextMenuCustomizeRibbon { get; } = "Şeridi Özelleştir...";
        public override string RibbonContextMenuMinimizeRibbon { get; } = "Şeridi Daralt";
