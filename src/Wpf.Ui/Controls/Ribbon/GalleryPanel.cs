...
public class GalleryPanel : StackPanel
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether gets or sets whether gallery panel shows groups
    ...
    public static readonly DependencyProperty ItemContainerGeneratorProperty =
        DependencyProperty.Register(
            ...
            typeof(GalleryPanel),
            new PropertyMetadata(OnItemContainerGeneratorChanged));
    ...
    private void Refresh()
    {
        ...
        foreach (UIElement? item in this.InternalChildren)
        {
            ...
            if (dictionary.ContainsKey(propertyValue) == false)
            {
                ...
                _ = this.visualCollection.Add(galleryGroupContainer);
            }

            var galleryItemPlaceholder = new GalleryItemPlaceholder(item);
            _ = dictionary[propertyValue].Items.Add(galleryItemPlaceholder);
        }
            ...
            && this.galleryGroupContainers.Count != 0)
        {
            ...
            this.galleryGroupContainers[0].SetCurrentValue(GalleryGroupContainer.IsHeaderedProperty, false);
        }
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        double width = 0;
        double height = 0;
        foreach (GalleryGroupContainer child in this.galleryGroupContainers)
        {
    ...
    protected override Size ArrangeOverride(Size finalSize)
    {
        ...
        foreach (GalleryGroupContainer item in this.galleryGroupContainers)
        {
            ...
            foreach (GalleryItemPlaceholder? placeholder in item.Items)
            {
                ...
                Point leftTop = placeholder.TranslatePoint(default, this);
    ...
    private string? GetPropertyValueAsString(object? item)
    {
        ...
        PropertyInfo? property = item.GetType().GetProperty(this.GroupBy, BindingFlags.Public | BindingFlags.Instance);
