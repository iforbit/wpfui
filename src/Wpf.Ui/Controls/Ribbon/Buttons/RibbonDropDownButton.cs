...
public class RibbonDropDownButton : ItemsControl, IRibbonControl, IDropDownControl, ILargeIconProvider, IMediumIconProvider, ISimplifiedStateControl
{
    ...
    public static readonly DependencyProperty ShowInSimplifiedProperty =
        DependencyProperty.Register(nameof(ShowInSimplified), typeof(bool), typeof(RibbonDropDownButton), new PropertyMetadata(BooleanBoxes.TrueBox));
