...
public class RibbonToggleButton : System.Windows.Controls.Primitives.ToggleButton, IToggleButton, IRibbonControl, ILargeIconProvider, IMediumIconProvider, ISimplifiedStateControl
{
    /// <inheritdoc />
    ...
    public static readonly DependencyProperty ShowInSimplifiedProperty =
        DependencyProperty.Register(nameof(ShowInSimplified), typeof(bool), typeof(RibbonToggleButton), new PropertyMetadata(BooleanBoxes.TrueBox));
