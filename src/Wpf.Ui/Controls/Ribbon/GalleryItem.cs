...
/// </summary>
public class GalleryItem : ListBoxItem, ICommandSource
{
    /// <summary>
    /// Gets a value indicating whether gets a value that indicates whether a Button is currently activated.
    ...
    /// <summary>
    /// Gets or sets a value indicating whether gets or sets whether ribbon control click must close backstage or popup.
    /// </summary>
    ...
    static GalleryItem()
    {
        ...
        _ = IsSelectedProperty.AddOwner(typeof(GalleryItem), new FrameworkPropertyMetadata(BooleanBoxes.FalseBox, FrameworkPropertyMetadataOptions.None, OnIsSelectedChanged));
    }
