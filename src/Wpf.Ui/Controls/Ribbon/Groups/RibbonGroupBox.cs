...
public class RibbonGroupBox : HeaderedItemsControl, IDropDownControl, IHeaderedControl, ILogicalChildSupport, IMediumIconProvider, ISimplifiedStateControl, ILargeIconProvider
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether this group should be shown in Simplified mode.
    /// </summary>
    ...
    public static readonly DependencyProperty ShowInSimplifiedProperty =
        DependencyProperty.Register(nameof(ShowInSimplified), typeof(bool), typeof(RibbonGroupBox), new PropertyMetadata(BooleanBoxes.TrueBox));
    ...
    private static void OnIsDropDownOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        (UIElementAutomationPeer.FromElement(groupBox) as RibbonGroupBoxAutomationPeer)?.RaiseExpandCollapseAutomationEvent(oldValue, newValue);
    ...
    /// <inheritdoc />
    protected override AutomationPeer OnCreateAutomationPeer() => new RibbonGroupBoxAutomationPeer(this);
}