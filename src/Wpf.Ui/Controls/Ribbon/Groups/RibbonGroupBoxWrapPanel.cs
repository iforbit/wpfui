...
public class RibbonGroupBoxWrapPanel : Panel
{
    ...
    /// <summary>
    /// Gets or sets the ItemWidth and ItemHeight properties specify the size of all items in the WrapPanel.
    ...
    /// <summary>
    /// Gets or sets specifies dimension of children positioning in absence of wrapping.
    ...
    private static void OnOrientationChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        _ = UIHelper.GetParent<RibbonGroupBox>(control)?.TryClearCacheAndResetStateAndScaleAndNotifyParentRibbonGroupsContainer();
    }
    ...
    {
        RibbonGroupBox? parentRibbonGroupBox = UIHelper.GetParent<RibbonGroupBox>(this);
