...
{
    private readonly double minimumLeftRightHeaderPadding = 5;
    ...
    protected override Size MeasureOverride(Size availableSize )
    {
        ...
        Size desiredSize = this.MeasureChildrenDesiredSize(availableSize);
            ...
            || DoubleUtil.GreaterThan(absoluteOverflowWidth, 2.0))
        {
            ...
            while (DoubleUtil.GreaterThan(absoluteOverflowWidth, 0))
            {
                ...
                foreach (RibbonTabItem? tab in visibleTabs)
                {
                    ...
                    Thickness newHeaderPadding = tab.HeaderPadding;
    ...
    protected override Size ArrangeOverride(Size finalSize )
    {
        ...
        IOrderedEnumerable<RibbonTabItem> orderedChildren = this.InternalChildren.OfType<RibbonTabItem>()
            .OrderBy(x => x.IsContextual);

        foreach (RibbonTabItem? item in orderedChildren)
        {
