...
using Wpf.Ui.Demo.Writer.Models;
using Wpf.Ui.Demo.Writer.Services;
using Wpf.Ui.DependencyInjection;

namespace Wpf.Ui.Demo.Writer;
    ...
    private static readonly IHost _host = Host.CreateDefaultBuilder()
        ...
        .ConfigureServices(
            (context, services) =>
            {
                ...
                _ = services.AddSingleton<Views.Pages.WriteBoardPage>();
                _ = services.AddSingleton<ViewModels.WriteBoardViewModel>();
